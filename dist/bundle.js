 ...
 */
var bind$1 = _curry2$5(function bind(fn, thisObj) {
...
var _curryN$1 = function _curryN(length, received, fn) {
  return function() {
    ...
    return left <= 0 ? fn.apply(this, combined)
                     : _arity$4(left, _curryN(length, combined, fn));
  };
};
 ...
 *      g(4); //=> 10
 */
var curryN$1 = _curry2$7(function curryN(length, fn) {
  if (length === 1) {
    return _curry1$6(fn);
  }
 ...
 */
var map$1 = _curry2$4(_dispatchable(['map'], _xmap, function map(fn, functor) {
 ...
 */
var lens$1 = _curry2$3(function lens(getter, setter) {
 ...
 */
var nth$1 = _curry2$8(function nth(offset, list) {
 ...
 */
var adjust$1 = _curry3$4(function adjust(fn, idx, list) {
 ...
 *      t(); //=> 'Tee'
 */
var always$1 = _curry1$8(function always(val) {
  return function() {
    return val;
  };
});
 ...
 * @symb R.update(1, a, [b, c]) = [b, a]
 */
var update$1 = _curry3$3(function update(idx, x, list) {
 ...
 */
var lensIndex = _curry1$4(function lensIndex(n) {
 ...
 */
var assoc$1 = _curry3$5(function assoc(prop, val, obj) {
  var result = {};
  for (var p in obj) {
    result[p] = obj[p];
  }
 ...
 *      R.prop('x', {}); //=> undefined
 */
var prop$1 = _curry2$9(function prop(p, obj) { return obj[p]; });
 ...
 *      R.over(xLens, R.negate, {x: 1, y: 2});  //=> {x: -1, y: 2}
 */
var lensProp = _curry1$9(function lensProp(k) {
  return lens$3(prop(k), assoc(k));
});
 ...
 */
var reduce$1 = _curry3$6(_reduce$3);
 ...
 */
var slice$1 = _curry3$7(_checkForMethod$3('slice', function slice(fromIndex, toIndex, list) {
 ...
 *      R.tail('');     //=> ''
 */
var tail$1 = _curry1$10(_checkForMethod('tail', slice(1, Infinity)));
 ...
 *      R.reverse('');         //=> ''
 */
var reverse$1 = _curry1$11(function reverse(list) {
  return _isString$4(list) ? list.split('').reverse().join('') :
...
*/
function BaseAutocomplete(h, over$$1, view, set){
    
  
  function Autocomplete( list, input, chosen, open, instanceConfig){
    
    var config = Object.assign({}, baseConfig, instanceConfig);
    var sort = function (a,b) { return [  [a,b].map( config.extractValue )  ]
      .map( function (ref) {
        var a = ref[0];
        var b = ref[1];
    ...
    return h('div'
      ,h('input'
         ...
         , oninput: function(e){
           ...
           , onfocus: function () { set(open)(true); }
           , onblur: function () { setTimeout( set(open), 0, false); }
         }
      )
...
BaseAutocomplete.queries = {
  root: function (f) { return function (s) { return over( lensIndex(0), f, s ); }; }
  ,input: function (f) { return function (s) { return over( compose( lensIndex(0), lensIndex(0) ) , f, s ); }; }
  ,list: function (f) { return function (s) { return over( compose( lensIndex(0), lensIndex(1) ) , f, s ); }; }
  ,listItems: function (f) { return function (s) { return over( compose( lensIndex(0), lensIndex(1), lensProp('children') ) , map$1(f), s ); }; }
};
